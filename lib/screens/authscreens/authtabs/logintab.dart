...
import 'package:scanner/widgets/auth_widgets/pagedisplay.dart';
import 'package:scanner/widgets/auth_widgets/slider_points.dart';
...
class _LoginTabState extends State<LoginTab> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   onPressed: () {
      //     var map = Employee(
      //       contactNumber: '+919893333654',
      //       emailId: 'pratham.sarankar123@gmail.com',
      //       name: 'Pratham Sarankar',
      //       parkingAreaId: '78k0GoHHQojUdBqOsiMP',
      //     ).toMap();
      //     FirebaseFirestore.instance.collection('employees').add(map);
      //     showToast('Done');
      //   },
      // ),
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (await Employee.exists(phoneNo)) {
                              widget.onOtpRequest(phoneNo);
                            } else {
                              showScannerExceptionDialog(
                                  context,
                                  ScannerException('Employee not found',
                                      'No employee exists with the given phone number. Please try again with another number.'));
                            }
                          },
                          child: Text(
                            'Verify my number',
